...
#define PROFILE_MAX_FREQ (2016000)	// ZZ: max possible freq in system table for freq adaption (possible OC frequencies inclusive)
...
struct zzmoove_profile zzmoove_profiles[] = {
	{
...
#endif /* ENABLE_SNAP_THERMAL_SUPPORT */
		1843200,	// scaling_block_freq (all valid system frequencies)
		...
		1689600,	// inputboost_punch_freq (0=disable, range from 0 to freq->max in khz)
...
#endif /* ENABLE_INPUTBOOSTER */
#ifdef ENABLE_MUSIC_LIMITS
		1689600,	// music_max_freq (0=disable, range from 0 to freq->max in khz)
		652800,		// music_min_freq (0=disable, range from 0 to freq->min in khz)
...
#endif /* (MAX_CORES == 8) */
		1036800,		// down_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		1401600,	// down_threshold_hotplug_freq2
		1843200,	// down_threshold_hotplug_freq3
#endif /* (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 6 || MAX_CORES == 8)
...
#endif /* ENABLE_INPUTBOOSTER */
#ifdef ENABLE_MUSIC_LIMITS
		1689600,	// music_max_freq
		652800,		// music_min_freq
		2,		// music_min_cores
#endif /* ENABLE_MUSIC_LIMITS */
		95,		// smooth_up
#if defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) || defined(USE_LCD_NOTIFIER)
...
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		1689600,	// up_threshold_hotplug_freq2
		2016000,	// up_threshold_hotplug_freq3
#endif /* (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 6 || MAX_CORES == 8)
	...
	},
	{
...
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		1401600,	// down_threshold_hotplug_freq2
		1689600,	// down_threshold_hotplug_freq3
#endif /* (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 6 || MAX_CORES == 8)
		0,		// down_threshold_hotplug_freq4
		0,		// down_threshold_hotplug_freq5
		...
		68,		// up_threshold_hotplug7
#endif /* (MAX_CORES == 8) */
		1401600,	// up_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		1689600,	// up_threshold_hotplug_freq2
		2016000,	// up_threshold_hotplug_freq3
#endif /* (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8) */
	...
	},
	{
...
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		1036800,		// down_threshold_hotplug_freq2
		1401600,	// down_threshold_hotplug_freq3
#endif /* (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 6 || MAX_CORES == 8)
		0,		// down_threshold_hotplug_freq4
		0,		// down_threshold_hotplug_freq5
		...
		1036800,		// up_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		1401600,	// up_threshold_hotplug_freq2
		1689600,	// up_threshold_hotplug_freq3
#endif /* (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 6 || MAX_CORES == 8)
		0,		// up_threshold_hotplug_freq4
		0,		// up_threshold_hotplug_freq5
...
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		1689600,	// up_threshold_hotplug_freq2
		1843200,	// up_threshold_hotplug_freq3
